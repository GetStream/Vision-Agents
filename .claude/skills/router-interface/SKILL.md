...
description: How to properly design a new router
---
...
Note that working on the router always touches the SDKs as well as the acceleration backend
...
What is configurable, what is similar and what is different.
