 ...
 *
 * Values: live,ended,unknown_default_open_api
 */
@Serializable(with = SessionStateSerializer::class)
internal enum class SessionState(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is SessionState) "$data" else null

        /**
         * Returns a valid [SessionState] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): SessionState? = data?.let {
...
internal object SessionStateSerializer : KSerializer<SessionState> {
    ...
    override fun deserialize(decoder: Decoder): SessionState {
        ...
        return SessionState.entries.firstOrNull { it.value == value }
            ?: SessionState.unknown_default_open_api
    }
