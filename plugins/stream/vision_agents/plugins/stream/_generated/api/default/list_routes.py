...
def sync_detailed(
    ...
    *,
    ...
    first is the one a conversation gets by default. Shortcuts that exist only for the router's own use
    are left out, though they can still be named as a target.
