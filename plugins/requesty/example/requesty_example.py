"""
Requesty LLM Example

This example demonstrates how to use the Requesty plugin with a Vision Agent,
...
async def create_agent(**kwargs) -> Agent:
    ...
    agent = Agent(
        edge=getstream.Edge(),
        agent_user=User(name="Requesty AI", id="agent"),
...
async def join_call(agent: Agent, call_type: str, call_id: str, **kwargs) -> None:
    ...
    logger.info("Starting Requesty Agent...")
