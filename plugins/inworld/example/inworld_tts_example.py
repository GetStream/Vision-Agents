...
async def create_agent(**kwargs) -> Agent:
    ...
    agent = Agent(
        ...
        instructions=f"You act fully as a video game character described in {voice_setup[current_voice]['readme_file']} . Always answer in less than 2000 characters. Make heavy use of @inworld-audio-guide.md to generate speech.",
        # instructions=test_instructions,
        tts=inworld.TTS(voice_id=voice_setup[current_voice]['voice_id'], model_id="inworld-tts-1-max"),
        stt=deepgram.STT(),
