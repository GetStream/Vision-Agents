...
Visual interpretation uses the vision skill in skills/vision.md, which runs on the
subagent with raw frames selected from the processor's retained observations.
