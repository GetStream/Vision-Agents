...
async def start_agent() -> None:
    ...
    with await agent.join(call):
        ...
        await agent.simple_response("tell me a fun story about two developers comparing OOP and functional, the text reply should contain some nice markdown formatting like bold and italic to reflect how they are talking to each other, also fine to include smileys in the text reply. THe idea is that they except small code snippets in haskell and java. Keep it smart and funny")
        await agent.finish()
