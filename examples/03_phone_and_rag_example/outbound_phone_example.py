...
async def media_stream(websocket: WebSocket, call_sid: str):
    ...
    try:
        ...
        phone_user = User(name=f"Outbound call {call_sid[:8]}", id=f"phone-{call_sid}")
        ...
        await join_phone_to_call(agent, stream_call, twilio_stream, phone_user)
...
async def run_with_server(from_number: str, to_number: str):
    ...
    initiate_outbound_call(from_number, to_number)
