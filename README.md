...
| MiniMax         | LLM plugin using MiniMax's high-performance models (MiniMax-M2.7, MiniMax-M2.7-highspeed, MiniMax-M2.5, MiniMax-M2.5-highspeed) with OpenAI-compatible API                                                                              | [MiniMax](https://platform.minimax.io/docs/api-reference/text-openai-api)                            |
